<template>
    <div class="menu-page"
      ...
      <div class="item"
        ...
        <menu-big-data v-if="item.type === 1 " :menuArr="item.recipe"></menu-big-data>
        <menu-big-data v-if="item.type === 3" :menuArr="item.recipe"></menu-big-data>
        <menu-sort-data v-if="item.type === 2" :menuArr="item.collectionsort"></menu-sort-data>
      </div>
    </div>
</template>
...
<script>
  ...
  import menuVideoData from '../widget/menuVideoData.vue';
